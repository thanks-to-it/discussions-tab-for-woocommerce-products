...
* Dev - New option added to allow administrators to post discussion comments.
* Dev - New option added to allow product authors to post discussion comments.
* Dev - Showing errors before trying to submit the discussion comment.
...
= 1.5.5 - 06/09/2024 =
* Dev - Added new option to enqueue the comment-reply script on the product page.
...
= 1.5.2 - 15/02/2024 =
* Fix - PHP warnings are being triggered.
* Dev - General - Guest users - Add option to hide discussion comments from guest users.
* Tested up to: 6.4.
* WC tested up to: 8.6.

= 1.5.1 - 23/10/2023 =
* Fix - General - AJAX discussions - Fix admin settings.

= 1.5.0 - 23/10/2023 =
* Fix - General - AJAX discussions - Improve compatibility with other plugins such as Porto.

= 1.4.9 - 23/10/2023 =
* Dev - Add compatibility to HPOS.
* WC tested up to: 8.2.
...
= 1.4.6 - 13/06/2023 =
* Fix - Too few arguments to function `Labels::create_comment_icons_html()`.
* WC tested up to: 7.7.
* Tested up to: 6.2.
...
= 1.4.0 - 18/07/2022 =
* Fix - AJAX discussions - Spinning position.
* Fix - Advanced - WooCommerce compatibility - Fix product reviews change from WooCommerce 6.7.0.
* WC tested up to: 6.7.
